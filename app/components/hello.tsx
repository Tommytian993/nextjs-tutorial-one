...
// Only the interactive parts are hydrated(before used are added as placeholders in the DOM), meaning the non-interactive parts are still static on the server
